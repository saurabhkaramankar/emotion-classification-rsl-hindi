...
# example for train: python run.py --mode="train" --pretrained="fasttext" --head_model="fc" --dataset="bhaav" --use_dataset=-1 --num_epochs=30 --batch_size=256 --learning_rate=1e-3
# example for test : python run.py --mode="test" --pretrained="fasttext" --head_model="fc" --weights="fastText/logs/bhaav/model.pth" --dataset="bhaav"
